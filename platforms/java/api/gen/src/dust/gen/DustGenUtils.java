...
public class DustGenUtils implements DustGenConsts {
	...
	public static String hashFileName(String fileName) {
		...
		String path = new StringBuilder(File.separator).append(String.format("%02x", firstDir)).append(File.separator)
				.append(String.format("%02x", secondDir)).append(File.separator).append(fileName).toString();
	...
	private static final EnumSet<DustResultType> RT_REJECT = EnumSet.of(DustResultType.NOTIMPLEMENTED,
			DustResultType.REJECT);
